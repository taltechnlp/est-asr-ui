 ...
 */
export const DEFAULT_MODEL = OPENROUTER_MODELS.GPT_4O;
...
export const AVAILABLE_MODELS_FOR_UI = [
	{ value: OPENROUTER_MODELS.GPT_4O, label: 'GPT-4o (Recommended)' },
	{ value: OPENROUTER_MODELS.GPT_5, label: 'GPT-5' },
	{ value: OPENROUTER_MODELS.GEMINI_2_5_PRO, label: 'Gemini 2.5 Pro (Unstable)' },
