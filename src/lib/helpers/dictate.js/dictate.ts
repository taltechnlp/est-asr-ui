// Code from https://github.com/Kaljurand/dictate.js/blob/master/lib/dictate.js
...
var SERVER_STATUS_CODE = {
	...
	9: 'Not available' // Recognizer processes are currently in use and recognition cannot be performed
};

export const Dictate = function (cfg) {
	var config = cfg || {};
	...
	function createWebSocket() {
		...
		// E.g. "Frame size of 65580 byte			dictate.startListening();s exceeds maximum accepted frame size"
		// Status codes
...
export const Transcription = function (cfg) {
	var index = 0;
	var list = [];
