...
const testScenarios = [
    {
        ...
        response: '["Supplementary budget confidence vote","Coalition dynamics","Family support bill","Inflation mitigation strategies","Child benefit increase proposal"]',
        description: "LLM returns just an array of topics instead of full object",
        expectedRecovery: "format_recovery"
    },
    {
        name: "String response",
        response: '"This is a summary of the political discussion about budget votes and coalition dynamics."',
